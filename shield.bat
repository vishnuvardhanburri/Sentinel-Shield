...
if /I "%~1"=="start" (
    echo --- SENTINEL SHIELD CONTROL (XAVIRA TECH LABS) ---
...
if /I "%~1"=="status" (
    echo --- SENTINEL SHIELD STATUS (XAVIRA TECH LABS) ---
...
if /I "%~1"=="ask" (
    ...
    echo --- SENTINEL SHIELD QUERY (XAVIRA TECH LABS) ---
...
if /I "%~1"=="audit-export" (
    echo --- SENTINEL SHIELD AUDIT (XAVIRA TECH LABS) ---
...
echo --- SENTINEL SHIELD (XAVIRA TECH LABS) ---
